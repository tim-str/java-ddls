...
--
-- Name: 1cbd787e864f57928826fcea52f2fe; Type: TABLE; Schema: eventstorage; Owner: cscpulse
--
...
ALTER TABLE eventstorage."1cbd787e864f57928826fcea52f2fe" OWNER TO cscpulse;

--
-- Name: 4cf993bb5be5806d15a4ed1549439d; Type: TABLE; Schema: eventstorage; Owner: cscpulse
--
...
ALTER TABLE eventstorage."4cf993bb5be5806d15a4ed1549439d" OWNER TO cscpulse;

--
-- Name: deced856d7f1865f0bdd4e178bb5fc; Type: TABLE; Schema: eventstorage; Owner: cscpulse
--
...
ALTER TABLE eventstorage.deced856d7f1865f0bdd4e178bb5fc OWNER TO cscpulse;

--
-- Name: FDZ_APP_MGDLIST_ITEM; Type: TABLE; Schema: pulse; Owner: cscpulse
--
...
CREATE TABLE pulse."FDZ_APP_MGDLIST_ITEM" (
    ...
    "TENANT_ID" character varying(22) DEFAULT '-'::character varying NOT NULL,
...
ALTER TABLE pulse."FDZ_APP_MGDLIST_ITEM" OWNER TO cscpulse;
...
--
-- Name: 1cbd787e864f57928826fcea52f2fe 375a7cfa995f75a6b70902a1fec0cb7e; Type: CONSTRAINT; Schema: eventstorage; Owner: cscpulse
--

ALTER TABLE ONLY eventstorage."1cbd787e864f57928826fcea52f2fe"
    ADD CONSTRAINT "375a7cfa995f75a6b70902a1fec0cb7e" PRIMARY KEY ("FDZ_UUID");


--
-- Name: 4cf993bb5be5806d15a4ed1549439d 9f663174c84cbd534ea96e4b622e99e3; Type: CONSTRAINT; Schema: eventstorage; Owner: cscpulse
--

ALTER TABLE ONLY eventstorage."4cf993bb5be5806d15a4ed1549439d"
    ADD CONSTRAINT "9f663174c84cbd534ea96e4b622e99e3" PRIMARY KEY ("FDZ_UUID");


--
-- Name: deced856d7f1865f0bdd4e178bb5fc eee045115306116ecdb4a4fc6da0674d; Type: CONSTRAINT; Schema: eventstorage; Owner: cscpulse
--

ALTER TABLE ONLY eventstorage.deced856d7f1865f0bdd4e178bb5fc
    ADD CONSTRAINT eee045115306116ecdb4a4fc6da0674d PRIMARY KEY ("FDZ_UUID");


--
-- Name: FDZ_APP_MGDLIST_ITEM a6d2d8b421ac7849a555e5bc4ec7ec39; Type: CONSTRAINT; Schema: pulse; Owner: cscpulse
--
...
--
-- Name: arch_casemanager_am_event_status; Type: INDEX; Schema: casemanager; Owner: csccasemanager
--

CREATE INDEX arch_casemanager_am_event_status ON casemanager."AM_EVENT_STATUS" USING btree ("TIMESTAMP");


--
-- Name: arch_casemanager_am_event_status_reason; Type: INDEX; Schema: casemanager; Owner: csccasemanager
--

CREATE INDEX arch_casemanager_am_event_status_reason ON casemanager."AM_EVENT_STATUS_REASON" USING btree ("TIMESTAMP");
...
--
-- Name: 597791c8d72c4578a1f85319f967a7d0; Type: INDEX; Schema: eventstorage; Owner: cscpulse
--

CREATE INDEX "597791c8d72c4578a1f85319f967a7d0" ON eventstorage.deced856d7f1865f0bdd4e178bb5fc USING btree ("FDZ_PARTITION_INDEX", "FDZ_timestamp");


--
-- Name: 7e04c5724eb7a7ed48aaafb3778eda48; Type: INDEX; Schema: eventstorage; Owner: cscpulse
--

CREATE INDEX "7e04c5724eb7a7ed48aaafb3778eda48" ON eventstorage."4cf993bb5be5806d15a4ed1549439d" USING btree ("FDZ_PARTITION_INDEX", "FDZ_timestamp");


--
-- Name: 8368bea68ee805817cf5017f6d5fdcd2; Type: INDEX; Schema: eventstorage; Owner: cscpulse
--

CREATE INDEX "8368bea68ee805817cf5017f6d5fdcd2" ON eventstorage."4cf993bb5be5806d15a4ed1549439d" USING btree ("FDZ_timestamp");


--
-- Name: b441df278305edd3ac9ca124a9ecc60c; Type: INDEX; Schema: eventstorage; Owner: cscpulse
--

CREATE INDEX b441df278305edd3ac9ca124a9ecc60c ON eventstorage.deced856d7f1865f0bdd4e178bb5fc USING btree ("FDZ_timestamp");


--
-- Name: b968246672594b042ef5d6bc60c4200e; Type: INDEX; Schema: eventstorage; Owner: cscpulse
--

CREATE INDEX b968246672594b042ef5d6bc60c4200e ON eventstorage."1cbd787e864f57928826fcea52f2fe" USING btree ("FDZ_timestamp");


--
-- Name: cee4afdff814b88c8958803a09b7615b; Type: INDEX; Schema: eventstorage; Owner: cscpulse
--

CREATE INDEX cee4afdff814b88c8958803a09b7615b ON eventstorage."1cbd787e864f57928826fcea52f2fe" USING btree ("FDZ_PARTITION_INDEX", "FDZ_timestamp");


--
-- Name: 04e22b8f3014a82c3763cc5ff5fd7753; Type: INDEX; Schema: pulse; Owner: cscpulse
--
...
--
-- Name: 7cf2c0033525848bd4e182ccffd8b217; Type: INDEX; Schema: pulse; Owner: cscpulse
--
...
--
-- Name: TABLE "FDZ_APP_MGDLIST_ITEM"; Type: ACL; Schema: pulse; Owner: cscpulse
--

GRANT ALL ON TABLE pulse."FDZ_APP_MGDLIST_ITEM" TO cscetl;
GRANT SELECT ON TABLE pulse."FDZ_APP_MGDLIST_ITEM" TO support;
GRANT SELECT ON TABLE pulse."FDZ_APP_MGDLIST_ITEM" TO datascience;
